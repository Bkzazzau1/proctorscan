...
HARDWARE_ITEMS = (
    ...
    HardwareItem("MicroSD storage", "VERIFIED / CONTROLLED LOCAL LOGGING", "Design bounded event-log retention before continuous logging"),
...
def hardware_status_text() -> str:
    ...
    lines.extend(("", "No unverified peripheral is approved for powered use."))
    return "\n".join(lines)
