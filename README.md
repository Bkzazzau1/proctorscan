...
Firmware `0.4.1` also performs an identification-only check of a card inserted in
...
The first physical test with firmware `0.4.0` reported `NOT_DETECTED` because the
